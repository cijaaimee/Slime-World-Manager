...
/**
 * SlimeLoaders are in charge of loading worlds from a data source, and also locking and deleting
 * them.
 */
public interface SlimeLoader {

    /**
     * Load a world's data file. In case {@code readOnly} is false, the world automatically gets
     * locked so no other server can access it in write-mode.
     *
     * @param worldName The name of the world.
     * @param readOnly If false, a {@link WorldInUseException} should be thrown when the world is
     *     locked.
     ...
     */
    byte[] loadWorld(String worldName, boolean readOnly)
     ...
     *
     * @param worldName The name of the world.
     * @return <code>true</code> if the world exists inside the data source, <code>false</code>
     *     otherwhise.
     * @throws IOException if the world could not be obtained.
     */
    ...
    /**
     * Saves the world's data file. This method will also lock the world, in case it's not locked
     * already.
     *
     * @param worldName The name of the world.
