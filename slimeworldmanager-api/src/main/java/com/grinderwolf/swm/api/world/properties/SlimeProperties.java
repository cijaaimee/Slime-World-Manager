...
public class SlimeProperties {
    ...
    public static final SlimeProperty DIFFICULTY =
            new SlimeProperty("difficulty", PropertyType.STRING, "peaceful", (value) -> {
                String difficulty = (String) value;
                return difficulty.equalsIgnoreCase("peaceful")
    ...
    public static final SlimeProperty ENVIRONMENT =
            new SlimeProperty("environment", PropertyType.STRING, "normal", (value) -> {
                String env = (String) value;
                return env.equalsIgnoreCase("normal")
                        || env.equalsIgnoreCase("nether")
                        || env.equalsIgnoreCase("the_end");
            });

    public static final SlimeProperty WORLD_TYPE =
            new SlimeProperty("worldtype", PropertyType.STRING, "default", (value) -> {
                String worldType = (String) value;
                return worldType.equalsIgnoreCase("default")
                        || worldType.equalsIgnoreCase("flat")
                        || worldType.equalsIgnoreCase("large_biomes")
                        || worldType.equalsIgnoreCase("amplified")
                        || worldType.equalsIgnoreCase("customized")
                        || worldType.equalsIgnoreCase("debug_all_block_states")
