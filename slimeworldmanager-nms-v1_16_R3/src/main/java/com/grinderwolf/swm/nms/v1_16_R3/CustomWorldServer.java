...
import com.grinderwolf.swm.nms.v1_16_R3.Converter;
import com.grinderwolf.swm.nms.v1_16_R3.CustomNBTStorage;
import com.grinderwolf.swm.nms.v1_16_R3.NMSSlimeChunk;
...
import net.minecraft.server.v1_16_R3.TickListChunk;
...
public class CustomWorldServer extends WorldServer {
    ...
    private final com.grinderwolf.swm.nms.v1_16_R3.CustomNBTStorage nbtStorage;

    @Getter
    @Setter
    private boolean ready = false;

    CustomWorldServer(CraftSlimeWorld world, CustomNBTStorage nbtStorage, Convertable.ConversionSession conversionSession, DimensionManager dimensionManager, World.Environment env, WorldDataServer worldDataServer, ResourceKey<net.minecraft.server.v1_16_R3.World> resourceKey, List<MobSpawner> list) {
        super(
        ...
        for (CompoundTag mapTag : world.getWorldMaps()) {
            ...
            map.a((NBTTagCompound) com.grinderwolf.swm.nms.v1_16_R3.Converter.convertTag(mapTag));
            a(map);
        }
    }
    ...
    public void save(IProgressUpdate progressUpdate, boolean forceSave, boolean flag1) {
        if (!slimeWorld.isReadOnly()) {
            ...
            for (WorldMap map : maps) {
                ...
                slimeWorld.getWorldMaps().add((CompoundTag) com.grinderwolf.swm.nms.v1_16_R3.Converter.convertTag("", compound));
            }
...
//            TickListChunk<FluidType> fluidChunkTickList = new TickListChunk(IRegistry.FLUID::getKey, new ArrayList<>());
        ...
        } else if (slimeChunk instanceof com.grinderwolf.swm.nms.v1_16_R3.NMSSlimeChunk) {
            chunk = ((com.grinderwolf.swm.nms.v1_16_R3.NMSSlimeChunk) slimeChunk).getChunk();
        } else {
            chunk = createChunk(slimeChunk);
            slimeWorld.updateChunk(new com.grinderwolf.swm.nms.v1_16_R3.NMSSlimeChunk(chunk));
        }
    ...
    private Chunk createChunk(SlimeChunk chunk) {
        ...
        for (int sectionId = 0; sectionId < chunk.getSections().length; sectionId++) {
            ...
            if (slimeSection != null) {
                ...
                section.getBlocks().a((NBTTagList) com.grinderwolf.swm.nms.v1_16_R3.Converter.convertTag(slimeSection.getPalette()), slimeSection.getBlockStates());

                if (slimeSection.getBlockLight() != null) {
                    lightEngine.a();
                    lightEngine.a(EnumSkyBlock.BLOCK, SectionPosition.a(pos, sectionId), com.grinderwolf.swm.nms.v1_16_R3.Converter.convertArray(slimeSection.getBlockLight()), true);
                }

                if (slimeSection.getSkyLight() != null) {
                    lightEngine.a(EnumSkyBlock.SKY, SectionPosition.a(pos, sectionId), com.grinderwolf.swm.nms.v1_16_R3.Converter.convertArray(slimeSection.getSkyLight()), true);
                }
        ...
        Consumer<Chunk> loadEntities = (nmsChunk) -> {
            ...
            if (tileEntities != null) {
                for (CompoundTag tag : tileEntities) {
                    ...
                    if (type.isPresent()) {
                        TileEntity entity = TileEntity.create(null, (NBTTagCompound) com.grinderwolf.swm.nms.v1_16_R3.Converter.convertTag(tag));
            ...
            if (entities != null) {
                for (CompoundTag tag : entities) {
                    EntityTypes.a((NBTTagCompound) com.grinderwolf.swm.nms.v1_16_R3.Converter.convertTag(tag), nmsChunk.world, (entity) -> {
    ...
    void saveChunk(Chunk chunk) {
        ...
        if (slimeChunk instanceof com.grinderwolf.swm.nms.v1_16_R3.NMSSlimeChunk) { // In case somehow the chunk object changes (might happen for some reason)
            ((com.grinderwolf.swm.nms.v1_16_R3.NMSSlimeChunk) slimeChunk).setChunk(chunk);
        } else {
