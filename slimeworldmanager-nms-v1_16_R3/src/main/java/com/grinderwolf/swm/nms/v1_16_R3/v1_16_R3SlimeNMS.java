...
public class v1_16_R3SlimeNMS implements SlimeNMS {
    ...
    private com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer defaultWorld;
    private com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer defaultNetherWorld;
    private com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer defaultEndWorld;
    ...
    private com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer initDefaultWorld(
        SlimeWorld world,
        ...
        com.grinderwolf.swm.nms.v1_16_R3.CustomNBTStorage dataManager = new com.grinderwolf.swm.nms.v1_16_R3.CustomNBTStorage(world, conversionSession);
        ...
        ResourceKey<net.minecraft.server.v1_16_R3.World> worldKey = ResourceKey.a(IRegistry.L, new MinecraftKey(world.getName()));

        return new com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer((CraftSlimeWorld) world, dataManager, conversionSession, dimensionManager, env, worldData, worldKey, Collections.emptyList());
    }
    ...
    public void generateWorld(SlimeWorld world) {
        com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer server = createNMSWorld(world);
        MinecraftServer mcServer = MinecraftServer.getServer();
    ...
    public SlimeWorld getSlimeWorld(World world) {
        ...
        if (!(craftWorld.getHandle() instanceof com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer)) {
            return null;
        }

        com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer worldServer = (com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer) craftWorld.getHandle();
        return worldServer.getSlimeWorld();
    }

    @Override
    public CompoundTag convertChunk(CompoundTag tag) {
        NBTTagCompound nmsTag = (NBTTagCompound) com.grinderwolf.swm.nms.v1_16_R3.Converter.convertTag(tag);
    ...
    @Override
    public com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer createNMSWorld(SlimeWorld world) {
        ...
        ResourceKey<net.minecraft.server.v1_16_R3.World> worldKey = ResourceKey.a(IRegistry.L, new MinecraftKey(worldName));

        MinecraftServer mcServer = MinecraftServer.getServer();
        Convertable.ConversionSession conversionSession = getConversionSession(worldName, mcServer, worldDimensionKey);
        com.grinderwolf.swm.nms.v1_16_R3.CustomNBTStorage dataManager = new CustomNBTStorage(world, conversionSession);

        DimensionManager dimensionManager = mcServer.customRegistry.a().a(dimensionManagerKey);
        WorldDataServer worldData = (WorldDataServer)dataManager.getWorldData();

        com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer server = null;
        ...
        server = new com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer((CraftSlimeWorld) world, dataManager, conversionSession, dimensionManager, env, worldData, worldKey, Collections.emptyList());
    ...
    public void addWorldToServerList(Object worldObject) {
        ...
        com.grinderwolf.swm.nms.v1_16_R3.CustomWorldServer server = (CustomWorldServer) worldObject;
