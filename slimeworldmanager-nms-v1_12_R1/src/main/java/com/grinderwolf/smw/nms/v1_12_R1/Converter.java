...
public class Converter {
    ...
    public static net.minecraft.server.v1_12_R1.NibbleArray convertArray(NibbleArray array) {
        return new net.minecraft.server.v1_12_R1.NibbleArray(array.getBacking());
    }

    public static NibbleArray convertArray(net.minecraft.server.v1_12_R1.NibbleArray array) {
