...
public class Converter {
    ...
    static net.minecraft.server.v1_15_R1.NibbleArray convertArray(NibbleArray array) {
        return new net.minecraft.server.v1_15_R1.NibbleArray(array.getBacking());
    }

    static NibbleArray convertArray(net.minecraft.server.v1_15_R1.NibbleArray array) {
        if (array == null) {
            return null;
        }
