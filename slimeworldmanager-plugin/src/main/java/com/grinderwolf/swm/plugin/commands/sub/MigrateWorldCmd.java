            ...
            if (newSource.equalsIgnoreCase(currentSource)) {
                sender.sendMessage(
                        Logging.COMMAND_PREFIX
                                ...
                                + "World "
                                + worldName
                                + " is already stored using data source "
                                + currentSource
                                + "!");
                    ...
                    .runTaskAsynchronously(
                            ...
                            () -> {
                                try {
                                    ...
                                    SWMPlugin.getInstance()
                                            .migrateWorld(worldName, oldLoader, newLoader);
                                    ...
                                    sender.sendMessage(
                                            Logging.COMMAND_PREFIX
                                                    ...
                                                    + "World "
                                                    + worldName
                                                    + " is being used on another server.");
                                    ...
                                    sender.sendMessage(
                                            Logging.COMMAND_PREFIX
                                                    ...
                                                    + "Data source "
                                                    + newSource
                                                    + " already contains a world named "
                                                    + worldName
                                                    + "!");
