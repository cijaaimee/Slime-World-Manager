                ...
                if (section != null) {
                    ...
                    for (int paletteIndex = 0; paletteIndex < palette.size(); paletteIndex++) {
                        ...
                        if (name.equals("minecraft:trapped_chest")) {
                            updateBlockEntities(
                                    chunk, sectionIndex, paletteIndex, "minecraft:chest", "minecraft:trapped_chest");
                        }
                ...
                for (CompoundTag entityTag : chunk.getEntities()) {
                    ...
                    switch (type) {
                        ...
                        case "minecraft:zombie_villager":
                            ...
                            int careerLevel =
                                    entityTag.getIntValue("CareerLevel").orElse(1);
                            ...
                            if (offersOpt.isPresent()) {
                                if (careerLevel == 0 || careerLevel == 1) {
                                    int amount = offersOpt
                                            .flatMap((offers) -> offers.getAsCompoundTag("Recipes"))
                                ...
                                entityTag
                                        ...
                                        .put(
                                                ...
                                                new IntTag(
                                                        "Xp",
                                                        VILLAGER_XP[
                                                                clamp(careerLevel - 1, 0, VILLAGER_XP.length - 1)]));
                            }
                            ...
                            dataMap.put(
                                    "profession",
                                    new StringTag("profession", getVillagerProfession(profession, career)));
            ...
            for (int sectionIndex = 0; sectionIndex < chunk.getSections().length; sectionIndex++) {
                ...
                if (section != null) {
                    ...
                    for (int paletteIndex = 0; paletteIndex < palette.size(); paletteIndex++) {
                        ...
                        if (name.equals("minecraft:trapped_chest")) {
                            updateBlockEntities(
                                    chunk, sectionIndex, paletteIndex, "minecraft:trapped_chest", "minecraft:chest");
                        }
                ...
                for (CompoundTag entityTag : chunk.getEntities()) {
                    ...
                    switch (type) {
                        ...
                        case "minecraft:zombie_villager":
                            // Villager data has changed
                            CompoundTag dataTag =
                                    entityTag.getAsCompoundTag("VillagerData").get();
                            String profession =
                                    dataTag.getStringValue("profession").get();
                        ...
                        if (val == paletteIndex) {
                            ...
                            for (CompoundTag tileEntityTag : chunk.getTileEntities()) {
                                ...
                                if (tileX == blockX && tileY == blockY && tileZ == blockZ) {
                                    String type =
                                            tileEntityTag.getStringValue("id").get();
